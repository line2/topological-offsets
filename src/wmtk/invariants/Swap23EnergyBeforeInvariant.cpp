...
Swap23EnergyBeforeInvariant<AttributeType>::Swap23EnergyBeforeInvariant(
    const Mesh& m,
...
template <typename AttributeType>
bool Swap23EnergyBeforeInvariant<AttributeType>::before(const simplex::Simplex& t) const
{
...
template class Swap23EnergyBeforeInvariant<Rational>;
template class Swap23EnergyBeforeInvariant<double>;
