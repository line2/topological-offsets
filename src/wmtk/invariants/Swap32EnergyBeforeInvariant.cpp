...
Swap32EnergyBeforeInvariant<AttributeType>::Swap32EnergyBeforeInvariant(
    const Mesh& m,
...
template <typename AttributeType>
bool Swap32EnergyBeforeInvariant<AttributeType>::before(const simplex::Simplex& t) const
{
    ...
    std::array<Eigen::Vector3<AttributeType>, 5> positions = {
    ...
    if constexpr (std::is_same<AttributeType, Rational>()) {
        positions_double = {
            {accessor.const_vector_attribute(v0).template cast<double>(),
             accessor.const_vector_attribute(v1).template cast<double>(),
             accessor.const_vector_attribute(v2).template cast<double>(),
             accessor.const_vector_attribute(v3).template cast<double>(),
             accessor.const_vector_attribute(v4).template cast<double>()}};
    } else {
...
template class Swap32EnergyBeforeInvariant<Rational>;
template class Swap32EnergyBeforeInvariant<double>;
